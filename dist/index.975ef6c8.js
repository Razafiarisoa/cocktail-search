...
document.querySelector(".splash-container").addEventListener("click", displaySearchBar);
// On attache un évenement lors du clique sur le bouton rechercher
document.querySelector(".search-bar button").addEventListener("click", searchForCocktails);
...
document.querySelector(".overlay .top-bar").addEventListener("click", closeOverlay);
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire9fde")
